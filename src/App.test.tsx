...
describe("Component loads products", () => {
  beforeEach(() => {
    fetchProducts.mockResolvedValue(testProducts);
  });

  test("presents a list of products on app load", async () => {
    render(<App />);
...
describe("Search list of products with text input", () => {
  beforeEach(() => {
    fetchProducts.mockResolvedValue(testProducts);
  });

  test("customer sees relevant list of products", async () => {
    render(<App />);
